          ...
          <div className="pixel-window p-8 md:p-12">
            <div className="pixel-window-header -mx-8 md:-mx-12 -mt-8 md:-mt-12 mb-8 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <span className="font-bubbly-title text-[var(--primary)] text-xs">BEV SOC</span>
              </div>
            ...
            <h1 className="font-bubbly-title text-2xl sm:text-3xl lg:text-4xl text-[var(--accent)] mb-6 leading-relaxed">
              Welcome to<br />
      ...
      <section className="py-24 bg-[var(--primary)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="font-bubbly-title text-xl sm:text-2xl text-[var(--accent)] mb-4">
              What We Offer
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              >
                ...
                <h3 className="font-bubbly-title text-sm text-[var(--accent)] mb-3">
                  {feature.title}
                </h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="font-bubbly-title text-2xl sm:text-3xl text-[var(--primary)] mb-2">
                  {stat.value}
                </div>
      ...
      <section className="py-24 bg-[var(--primary)] relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          <div className="pixel-window p-8">
            <h2 className="font-bubbly-title text-lg sm:text-xl text-[var(--accent)] mb-6">
              Ready to Join? ✨
            </h2>
