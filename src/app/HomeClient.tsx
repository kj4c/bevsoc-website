            ...
            {[
              {
                ...
                imageAlt: 'BevSoc members socialising at a UNSW Beverage Society event',
              },
              {
                icon: <Wine/>,
                title: 'Events',
                ...
                imageAlt: 'UNSW BevSoc Hallowasted 2025 event photo',
              ...
              >
                ...
                <div className="group relative w-full h-44 sm:h-52 lg:h-60 rounded-lg overflow-hidden bg-cream mt-auto">
                  ...
                  {'hoverText' in feature && (
                    <div className="absolute inset-0 flex items-center justify-center bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
          ...
          <div className="pixel-window p-6 sm:p-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                <img
                  src="/rubric.png"
                  alt="Rubric logo (BevSoc membership sign-up)"
